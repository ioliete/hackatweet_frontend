      ...
      <main className={styles.main}>
        <div className={styles.leftBar}>
          ...
          <div className={styles.middleBarUp}>
            ...
            <Button type="primary" shape="round" >Tweet</Button>
          </div>
          ...
          <div className={styles.tweetsContainer}>
            <div className={styles.tweet}>
              ...
              <div className={styles.tweetActions}>
                <FontAwesomeIcon className={styles.counterLike} icon={faHeart} />
        ...
        <div className={styles.rightBar}>
          ...
          <div className={styles.trendsContainer}>
            <div className={styles.trendHashtag}>
              <h3 className={styles.hashtagContent}>hashtag content</h3>
